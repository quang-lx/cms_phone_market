...
namespace Modules\Admin\Http\Controllers\Api\Attribute;

use Illuminate\Http\Request;
use Illuminate\Http\Response;
use Modules\Mon\Entities\Attribute;
use Modules\Admin\Http\Requests\Attribute\CreateAttributeRequest;
use Modules\Admin\Transformers\AttributeTransformer;
use Modules\Admin\Http\Requests\Attribute\UpdateAttributeRequest;
