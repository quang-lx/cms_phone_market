...
namespace Modules\Admin\Http\Controllers\Api\PaymentMethod;

use Illuminate\Http\Request;
use Illuminate\Http\Response;
use Modules\Mon\Entities\PaymentMethod;
use Modules\Admin\Http\Requests\PaymentMethod\CreatePaymentMethodRequest;
use Modules\Admin\Transformers\PaymentMethodTransformer;
use Modules\Admin\Http\Requests\PaymentMethod\UpdatePaymentMethodRequest;
