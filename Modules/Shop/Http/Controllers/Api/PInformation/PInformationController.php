...
namespace Modules\Shop\Http\Controllers\Api\PInformation;

use Illuminate\Http\Request;
use Illuminate\Http\Response;
use Modules\Mon\Entities\PInformation;
use Modules\Shop\Http\Requests\PInformation\CreatePInformationRequest;
use Modules\Shop\Transformers\PInformationTransformer;
use Modules\Shop\Http\Requests\PInformation\UpdatePInformationRequest;
