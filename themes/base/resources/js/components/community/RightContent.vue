<template>
  <aside class="w-296 js-right-side node5-2">
            ...
            <div class="flex row between-start pt-16 pl-16 pr-16 pb-16 rel pseu-bottom-2">
              <div class="offset-w-64">
                ...
                <button class="mt-8 w-88 h-32 flex col center-center border-8">
                  <span class="color-3 txt-13-16 weight-bold">{{ trans('base.Read More') }}</span>
                </button>
              </div>
    ...
    <div :class="jobs.length > 0 ? 'bg-2 mt-16' : 'bg-2'">
...
export default {
  ...
  created () {
    request.get('/communities/featured?page=1&per_page=5')
      .then((response) => {
