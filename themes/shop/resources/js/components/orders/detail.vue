                  ...
                  <div class="col-md-12">
                    <div class="row">
                      ...
                      <!-- <div class="col-md-12 mt-5">
                        ...
                        <div class="col-md-12" v-if="modelForm.order_type == 'sua_chua' && modelForm.type_other == 1 && modelForm.status_value == 'created'">
...
export default {
  ...
  methods: {
    ...
    onSubmit() {
     ...
     getRoute() {
        return route('apishop.orders.update', {orders: this.$route.params.ordersId});
      },
