<template>
  <div>
    ...
    <div class="jsThumbnailImageWrapper jsSingleThumbnailWrapper" v-if="hasSelectedMedia">
      <draggable :list="this.selectedMedia" :options="{group:'images'}" @start="drag=true" @end="drag=false"
                 @change="changeOrder">
        <div style="display:flex">
          <div class="row">
            <div v-for="media in this.selectedMedia" :key="media.id" class="file-in-multiple col-md-3"
                 style="display: flex">
              <figure
