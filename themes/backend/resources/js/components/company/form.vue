                        ...
                        <div class="row">
                            <div class="col-12">
                                <el-breadcrumb separator="/">
                                    ...
                                    <el-breadcrumb-item :to="{name: 'admin.company.index'}">{{ $t('company.label.company') }}
                                    </el-breadcrumb-item>
                                ...
                                >
                                    <div class="row">
                                        <div class="col-md-6 pr-5">
                                            <el-form-item :label="$t('company.label.name')"
                                            ...
                                            <el-form-item :label="$t('company.label.phone')"
                                            ...
                                            <el-form-item :label="$t('company.label.email')"
                                            ...
                                            <el-form-item :label="$t('company.label.level')"
                                                          :class="{'el-form-item is-error': form.errors.has('level') }">
                                                <el-radio-group v-model="modelForm.level">
                                                    <el-radio v-for="item in listLevel" :label="item.value" :key="item.lable">{{item.label}}</el-radio>
                                        ...
                                        <div class="col-md-6 pl-5">
                                            ...
                                            <el-form-item :label="$t('company.label.status')"
                                                ...
                                                <el-radio-group v-model="modelForm.status">
                                                    <el-radio v-for="item in listStatus" :label="item.value" :key="item.lable">{{item.label}}</el-radio>
        ...
        methods: {
            ...
            fetchData() {
                ...
                if (this.$route.params.companyId !== undefined) {
                    this.loading = true;
                    routeUri = route('api.company.find', {company: this.$route.params.companyId});
                    axios.get(routeUri)
                        .then((response) => {
                            this.loading = false;
            ...
            getRoute() {
                if (this.$route.params.companyId !== undefined) {
                    return route('api.company.update', {company: this.$route.params.companyId});
                }
