        ...
        <div class="row mb-2">
          <div class="col-12">
            <el-breadcrumb separator="/">
              ...
              <el-breadcrumb-item :to="{ name: 'admin.banners.index' }"
                >{{ $t("banners.label.banners") }}
              </el-breadcrumb-item>
                  ...
                  <div class="row">
                    <div class="col-md-12">
                      <div class="row">
                        <div class="col-md-10">
                          <el-form-item
                            :label="$t('banners.label.description')"
                            :class="{
                        ...
                        <div class="col-md-10">
                          <single-media
                            ...
                            "
                            label="Ảnh"
                            entity="Modules\Mon\Entities\Banners"
                            :entity-id="$route.params.bannersId"
                          ></single-media>
                          <div
                            class="el-form-item__error"
...
export default {
  ...
  methods: {
    onSubmit() {
      ...
      this.form
        ...
        .then((response) => {
          ...
          this.$router.push({ name: "admin.banners.index" });
        })
        .catch((error) => {
          this.loading = false;
          this.$notify.error({
    ...
    fetchData() {
      let routeUri = "";
      if (this.$route.params.bannersId !== undefined) {
        this.loading = true;
        routeUri = route("api.banners.find", {
          banners: this.$route.params.bannersId,
        });
    ...
    getRoute() {
      if (this.$route.params.bannersId !== undefined) {
        return route("api.banners.update", {
          banners: this.$route.params.bannersId,
        });
      }
      return route("api.banners.store");
    },
  },
  mounted() {
    this.fetchData();
