                        ...
                        <div class="row ">
                            ...
                            <div class="col-sm-9 text-right">
                                <div class="row">
                                    ...
                                    <div class="col-3">
                                        <router-link :to="{name: 'admin.pinformation.create'}">
                                    ...
                                    <el-table
                                        ...
                                        <el-table-column prop="actions" width="130">
                                            <template slot-scope="scope">
                                                <edit-button
                                                        :to="{name: 'admin.pinformation.edit', params: {pinformationId: scope.row.id}}"></edit-button>
    ...
    export default {
        ...
        methods: {
            queryServer(customProperties) {
                ...
                axios.get(route('api.pinformation.index', _.merge(properties, customProperties)))
                    .then((response) => {
